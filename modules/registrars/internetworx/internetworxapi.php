...
class domrobot
{
    ...
    public function call($object, $method, $params = [])
    {
        ...
        $request = xmlrpc_encode_request($action, $params, ['encoding' => 'UTF-8', 'escaping' => 'markup', 'verbosity' => 'no_white_space']);
        ...
        logModuleCall('internetworx', $action, $request, $_SiteResponse, $response, ['pass']);
