<?php
/*
 * generated by INWX on 2020-10-06
 *
 */
...
// .ORG.PT
$additionaldomainfields[".org.pt"] = array();
$additionaldomainfields[".org.pt"][] = array(
		"Name" => "TAX-NUMBER",
		"InwxName" => "TAX-NUMBER",
		"DisplayName" => "Tax number",
...
$additionaldomainfields[".ie"][] = array(
		...
		"Required" => true,
		"Options" => "Company (Ltd.  PLC  etc.),Sole Trader,Organization (Band  Club  local Group  etc.),Educational Institution,State agency,Charity,Natural Person (e.g. Blogger/Other)",
		"InwxOptions" => "COMPANY,BUSINESS,ORGANIZATION,EDUCATION,GOVERNMENT,CHARITY,OTHER",
	);
...
// .BIZ.KI
$additionaldomainfields[".biz.ki"] = array();
$additionaldomainfields[".biz.ki"][] = array(
		"Name" => "COCCA-REGISTRATION-TAC-APPROVED",
		"InwxName" => "COCCA-REGISTRATION-TAC-APPROVED",
		"DisplayName" => "I confirm the correctness of the email address of the domain owner and admin-c. The registry sends an activation-link to those addresses which should be confirmed by the recipient. Without a confirmation, the domain will be suspended after 21 days and is deleted afterwards. The costs will not be refunded.",
...
// .COM.KI
$additionaldomainfields[".com.ki"] = array();
$additionaldomainfields[".com.ki"][] = array(
		"Name" => "COCCA-REGISTRATION-TAC-APPROVED",
		"InwxName" => "COCCA-REGISTRATION-TAC-APPROVED",
		"DisplayName" => "I confirm the correctness of the email address of the domain owner and admin-c. The registry sends an activation-link to those addresses which should be confirmed by the recipient. Without a confirmation, the domain will be suspended after 21 days and is deleted afterwards. The costs will not be refunded.",
...
// .NET.KI
$additionaldomainfields[".net.ki"] = array();
$additionaldomainfields[".net.ki"][] = array(
		"Name" => "COCCA-REGISTRATION-TAC-APPROVED",
		"InwxName" => "COCCA-REGISTRATION-TAC-APPROVED",
		"DisplayName" => "I confirm the correctness of the email address of the domain owner and admin-c. The registry sends an activation-link to those addresses which should be confirmed by the recipient. Without a confirmation, the domain will be suspended after 21 days and is deleted afterwards. The costs will not be refunded.",
...
// .ORG.KI
$additionaldomainfields[".org.ki"] = array();
$additionaldomainfields[".org.ki"][] = array(
		"Name" => "COCCA-REGISTRATION-TAC-APPROVED",
		"InwxName" => "COCCA-REGISTRATION-TAC-APPROVED",
		"DisplayName" => "I confirm the correctness of the email address of the domain owner and admin-c. The registry sends an activation-link to those addresses which should be confirmed by the recipient. Without a confirmation, the domain will be suspended after 21 days and is deleted afterwards. The costs will not be refunded.",
...
// .INFO.KI
$additionaldomainfields[".info.ki"] = array();
$additionaldomainfields[".info.ki"][] = array(
		"Name" => "COCCA-REGISTRATION-TAC-APPROVED",
		"InwxName" => "COCCA-REGISTRATION-TAC-APPROVED",
		"DisplayName" => "I confirm the correctness of the email address of the domain owner and admin-c. The registry sends an activation-link to those addresses which should be confirmed by the recipient. Without a confirmation, the domain will be suspended after 21 days and is deleted afterwards. The costs will not be refunded.",
