<?php
/*
 * generated by INWX on 2021-11-04
 *
 */
...
$additionaldomainfields[".new"][] = array(
		...
		"DisplayName" => "I am aware that my new .NEW domain is more secure since it is HSTS preloaded and I need to run my website or my server with an SSL certificate in order to use the domain.
